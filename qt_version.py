...
class LaunchThread(QThread):
    ...
    def run(self):
        ...
        forge.install_forge_version(find_forge_version("1.12.2"), minecraft_directory)
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setFixedSize(512, 300)
        self.setWindowTitle('AncapLauncher')
        self.centralwidget = QWidget(self)

        self.logo = QLabel(self.centralwidget)
        self.logo.setMaximumSize(QSize(512, 74))
        self.logo.setText('')
    ...
    def launch_game(self):
        self.launch_thread.launch_setup_signal.emit('1.12.2', self.username.text())
